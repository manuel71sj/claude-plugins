...
```
/plugin install <plugin-name>@manuel71-plugins
```
...
# 플러그인 비활성화
/plugin disable telegram@manuel71-plugins

# 플러그인 재활성화
/plugin enable telegram@manuel71-plugins

# 플러그인 제거
/plugin uninstall telegram@manuel71-plugins

# 마켓플레이스 업데이트 (새 플러그인/버전 반영)
/plugin marketplace update manuel71-plugins
```
